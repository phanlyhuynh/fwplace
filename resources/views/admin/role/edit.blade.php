    ...
    <div class="row">
        <div class="col-md-12">
            <div class="m-portlet m-portlet--space">
                ...
                {!! Form::model($role, ['url' => 'admin/roles/' . $role->id, 'method' => 'PATCH', 'class' => 'm-form']) !!}
                <div class="m-portlet__body">
                    ...
                    <div class="form-group m-form__group">
                        ...
                        <div class="m-checkbox-list">
                            {!! Form::select('permission_id[]', $permissions, $permissionsSelecteds, ['class' => 'form-control m-input', 'id' => 'exampleSelect2', 'multiple' => true]) !!}
                        </div>
                    </div>
