...
@section('module')
    <div class="mr-auto">
        <h3 class="m-subheader__title m-subheader__title--separator">{{ __('User') }}</h3>
        <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
            ...
            <li class="m-nav__item">
                <a href="{{ url('admin/users') }}" class="m-nav__link">
                    <span class="m-nav__link-text">{{ __('User') }}</span>
                </a>
            </li>
            <li class="m-nav__separator">-</li>
            <li class="m-nav__item">
                <span class="m-nav__link-text">{{ __('Add new User') }}</span>
            </li>
        </ul>
    </div>
@endsection
            ...
            <div class="m-portlet__body">
                ...
                <div class="form-group m-form__group row">
                    <div class="col-lg-6">
                        ...
                        <span class="m-form__help">{{ __('Please enter Password') }}</span>
                    </div>
                    <div class="col-lg-6">
                ...
                @if (Auth::user()->role == config('site.permission.admin'))
                    <div class="form-group m-form__group row">
                        <div class="col-lg-6">
                            ...
                            <div class="m-input-icon m-input-icon--right">
                                {!! Form::select('role', [config('site.permission.trainee') => trans('Trainee'), config('site.permission.trainer') => trans('Trainer'), config('site.permission.admin') => trans('Admin')], null, ['class' => 'form-control m-input']) !!}
                            </div>
