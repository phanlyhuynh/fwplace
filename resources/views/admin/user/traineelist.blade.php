...
@section('title', __('Trainee List'))
@section('module')
    <div class="mr-auto">
        <h3 class="m-subheader__title m-subheader__title--separator">{{ __('Trainee List') }}</h3>
    </div>
@endsection
@section('content')
    <div class="row">
        <div class="col-xl-12">
            <div class="m-portlet m-portlet--tab">
                ...
                <div class="m-portlet__body">
                    {!! Form::open(['url' => 'admin/traineelists/' . Auth::user()->id, 'method' => 'GET', 'class' => 'm-form m-form--fit m--margin-bottom-20']) !!}
